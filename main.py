...
class Grid:
    ...
    def put(self, val):
        ...
        if self.squares[row][col].value == 0:
            ...
            if is_Safe(self.model, val, (row,col)) and self.solve():
                return True
            else:
    ...
    def draw(self):
        ...
        for i in range(self.rows+1):
            if i % 3 == 0 and i != 0:
                ...
                wide = 1
            pygame.draw.line(self.win, (0,0,0), (0, i*gap), (self.width, i*gap), wide)
            pygame.draw.line(self.win, (0,0,0), (i*gap, 0), (i*gap, self.height), wide)
    ...
    while run:     # Game loop 
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_RETURN:
                    ...
                    if board.squares[i][j].temp != 0:
                        if board.put(board.squares[i][j].temp):
                            print("Success")
                        else:
                            print("Wrong")
                            strikes += 1
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if clicked:
                    board.select(clicked[0], clicked[1])  # Selecting that row,col
                    key = None
